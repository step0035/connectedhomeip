...
\
  ...
  { 0x00000000, ZAP_TYPE(ARRAY), ERROR: device list, invalid size, array, 0, ZAP_EMPTY_DEFAULT() }, /* device list */  \
  { 0x00000001, ZAP_TYPE(ARRAY), ERROR: server list, invalid size, array, 0, ZAP_EMPTY_DEFAULT() }, /* server list */  \
  { 0x00000002, ZAP_TYPE(ARRAY), ERROR: client list, invalid size, array, 0, ZAP_EMPTY_DEFAULT() }, /* client list */  \
  { 0x00000003, ZAP_TYPE(ARRAY), ERROR: parts list, invalid size, array, 0, ZAP_EMPTY_DEFAULT() }, /* parts list */  \
  { 0x0000FFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(1) }, /* ClusterRevision */  \
\
  /* Endpoint: 1, Cluster: Thermostat (server) */ \
  ...
  { 0x0000001B, ZAP_TYPE(ENUM8), 1, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_MIN_MAX_DEFAULTS_INDEX(1) }, /* control sequence of operation */  \
  { 0x0000001C, ZAP_TYPE(ENUM8), 1, ZAP_ATTRIBUTE_MASK(MIN_MAX) | ZAP_ATTRIBUTE_MASK(WRITABLE), ZAP_MIN_MAX_DEFAULTS_INDEX(2) }, /* system mode */  \
  { 0x0000FFFD, ZAP_TYPE(INT16U), 2, 0, ZAP_SIMPLE_DEFAULT(3) }, /* ClusterRevision */  \
}
...
#define GENERATED_CLUSTERS { \
  ...
  { \
      ...
      .attributeCount = 5, \
      .clusterSize = 0ERROR: device list, invalid size, arrayERROR: server list, invalid size, arrayERROR: client list, invalid size, arrayERROR: parts list, invalid size, array2, \
      .mask = ZAP_CLUSTER_MASK(SERVER), \
      .functions = NULL, \
      .acceptedCommandList = nullptr ,\
      .generatedCommandList = nullptr ,\
...
#define GENERATED_ENDPOINT_TYPES { \
  { ZAP_CLUSTER_INDEX(0), 26, 545 }, \
  { ZAP_CLUSTER_INDEX(26), 6, 110ERROR: device list, invalid size, arrayERROR: server list, invalid size, arrayERROR: client list, invalid size, arrayERROR: parts list, invalid size, array2010 }, \
}
...
#define ATTRIBUTE_MAX_SIZE (556ERROR: device list, invalid size, arrayERROR: server list, invalid size, arrayERROR: client list, invalid size, arrayERROR: parts list, invalid size, array2222112)
...
#define FIXED_DEVICE_TYPES {{0x0016,1},{0x0300,1}}

...
add_subdirectory(${chip_dir}/third_party/pigweed/repo ${chip_dir}/examples/hvac-app/ameba/out/pigweed)
add_subdirectory(${chip_dir}/third_party/nanopb/repo ${chip_dir}/examples/hvac-app/ameba/out/nanopb)
add_subdirectory(${chip_dir}/examples/platform/ameba/pw_sys_io ${chip_dir}/examples/hvac-app/ameba/out/pw_sys_io)
...
list(
    ...
    ${chip_dir}/zzz_generated/hvac-app/zap-generated/callback-stub.cpp
    ${chip_dir}/zzz_generated/hvac-app/zap-generated/IMClusterCommandHandler.cpp
    ${chip_dir}/examples/hvac-app/ameba/main/chipinterface.cpp
    ${chip_dir}/examples/hvac-app/ameba/main/DeviceCallbacks.cpp
    ${chip_dir}/examples/hvac-app/ameba/main/CHIPDeviceManager.cpp
    ${chip_dir}/examples/hvac-app/ameba/main/Globals.cpp
    ${chip_dir}/examples/hvac-app/ameba/main/DsoHack.cpp
    ${chip_dir}/examples/hvac-app/ameba/main/ThermostatManager.cpp
)
...
chip_configure_data_model(chip_main
    INCLUDE_SERVER
    ZAP_FILE ${matter_example_path}/../hvac-common/hvac.zap
)
...
target_include_directories(
    ...
    PUBLIC
    ${inc_path}
    ${chip_dir}/zzz_generated/hvac-app
    ${chip_dir}/zzz_generated/hvac-app/zap-generated
    ${chip_dir}/zzz_generated/app-common
    ${chip_dir}/examples/hvac-app/hvac-common
    ${chip_dir}/examples/hvac-app/hvac-common/include
    ${chip_dir}/examples/hvac-app/ameba/main/include

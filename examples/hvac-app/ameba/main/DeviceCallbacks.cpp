                                                  ...
                                                  uint8_t type, uint16_t size, uint8_t * value)
{
    ...
    case ZCL_THERMOSTAT_CLUSTER_ID:
        ThermostatPostAttributeChangeCallback(endpointId, attributeId, value);
        break;

    case ZCL_FAN_CONTROL_CLUSTER_ID:
        FanControlPostAttributeChangeCallback(endpointId, attributeId, value);
        break;
...
void DeviceCallbacks::ThermostatPostAttributeChangeCallback(EndpointId endpointId, AttributeId attributeId, uint8_t * value)
{
...
void DeviceCallbacks::FanControlPostAttributeChangeCallback(EndpointId endpointId, AttributeId attributeId, uint8_t * value)
{

    VerifyOrExit(endpointId == 3, ChipLogError(DeviceLayer, TAG, "Unexpected EndPoint ID: `0x%02x'", endpointId));
    switch (attributeId)
    {
    case ZCL_FAN_MODE_ATTRIBUTE_ID:
        fan1.ModeAtt(*value);
        break;
    case ZCL_FAN_MODE_SEQUENCE_ATTRIBUTE_ID:
        fan1.ModeSeq(*value);
        break;
    case ZCL_PERCENT_SETTING_ATTRIBUTE_ID:
        fan1.SetPercent(*value);
        break;
    case ZCL_PERCENT_CURRENT_ATTRIBUTE_ID:
        fan1.CurrPercent(*value);
        break;
    default:
        ChipLogError(DeviceLayer, TAG, "Unhandled Attribute ID: '0x%04x", attributeId);
        break;
